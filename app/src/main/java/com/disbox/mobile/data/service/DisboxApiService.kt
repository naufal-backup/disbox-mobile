...
class DisboxApiService {
    ...
    suspend fun createShareLink(workerUrl: String, apiKey: String, request: ShareLinkRequest): Map<String, Any>? {
        val body = gson.toJson(request).toRequestBody("application/json".toMediaTypeOrNull())
